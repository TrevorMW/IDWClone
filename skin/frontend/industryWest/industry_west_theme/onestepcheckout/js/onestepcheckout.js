...
var OneStepCheckoutLoginPopup = Class.create(
{
  initialize: function(options)
  {
    ...
    this.popup_close_link = $('popup-close-link');
    this.popup = null;
    this.createPopup();
    this.mode = 'login';
  ...
  bindEventHandlers: function()
  {
    ...
    if (this.popup_link)
    {
      ...
      {
        e.preventDefault();
        this.popup_container.addClassName( 'active-popup');
      }.bind(this));
    }
    ...
    {
      this.popup_close_link.observe('click', function(e)
      {
        this.popup_container.removeClassName('active-popup');
      }.bind(this));
    }
