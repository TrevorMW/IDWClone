...
class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
{
    ...
    const XML_PATH_WHOLESALE_EMAIL_IDENTITY = 'customer/create_wholesale/email_identity';
    /**#@-*/
    ...
    public function validate()
    {
        ...
        // FIX FOR PASSWORD CONFIRMATION INCONSISTENCY, Y NOT BOTH??
        $confirmation = '';
        $this->getConfirmation() ? $confirmation = $this->getConfirmation() : $confirmation = $this->getPasswordConfirmation() ;
