...
class Inchoo_FeaturedProducts_Block_Adminhtml_Edit_Grid extends Mage_Adminhtml_Block_Widget_Grid {
          ...
          //<![CDATA[
            ...
            function FeaturedRowClick(grid, event)
            {
              var trElement = Event.findElement(event, "tr"),
                  ...
                  checkbox  = Element.getElementsBySelector(trElement, "input.checkbox" ).first();
    ...
    private function _appendHtml()
    {
      $html = '<script type="text/javascript">
    		...
    		var checkBoxes = $H(),
    		    checkbox_all = $$("#inchoo_featured_products_table thead input.checkbox").first(),
    		    everycheckbox = $$("#inchoo_featured_products_table tbody input.checkbox");
...
/*  OLD VERSION OF THIS FUNCTION, FIXED VERSION ABOVE
